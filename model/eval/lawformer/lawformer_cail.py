...
# # 30个测试集，124个训练集  随机选取15个偶数
# even_numbers = list(range(0, 153, 2))
# selected_numbers = random.sample(even_numbers, 15)
# # 每个元素加 1
# new_list = [x + 1 for x in selected_numbers]
# # 合并两个列表
# combined_list = selected_numbers + new_list
# # 输出结果
...
for epoch in range(num_epochs):
    ...
    with open('LCRCheck/results/save/lawformer_cail_loss.txt','a',encoding="utf8") as f:
...
torch.save(model.state_dict(), "LCRCheck/results/save/lawformer_cail.pth")
print('已保存')
