...
parser.add_argument('--s', type=str,
                    ...
                    help='Stopword path.')
parser.add_argument('--can1', type=str, default='C:/Users/11649/Desktop/LCR/data/query/危险驾驶罪.json',
                    help='Candidate path.')
...
with open(args.can1, "r", encoding="utf8") as g:
    ...
    with open('C:/Users/11649/Desktop/LCR/data/corpus/危险驾驶罪/wxjs_corpus.json', 'w', encoding="utf8") as f:
