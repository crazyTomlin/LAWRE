...
parser.add_argument('--s', type=str,
                    ...
                    help='Stopword path.')
parser.add_argument('--can1', type=str, default='C:/Users/11649/Desktop/LCR/data/query/故意杀人罪.json',
                    help='Candidate path.')
...
with open(args.can1, "r", encoding="utf8") as g:
    ...
    with open('C:/Users/11649/Desktop/LCR/data/corpus/故意杀人罪/gysr_corpus.json', 'w', encoding="utf8") as f:
