...
parser.add_argument('--s', type=str,
                    ...
                    help='Stopword path.')
parser.add_argument('--can1', type=str, default='C:/Users/11649/Desktop/LCR/data/query/盗窃罪.json',
                    help='Candidate path.')
...
with open(args.can1, "r", encoding="utf8") as g:
    ...
    with open('C:/Users/11649/Desktop/LCR/data/corpus/盗窃罪/dq_corpus.json', 'w', encoding="utf8") as f:
