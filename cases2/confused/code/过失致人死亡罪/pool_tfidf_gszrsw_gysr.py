...
parser.add_argument('--q', type=str, default='C:/Users/11649/Desktop/LCR/data/query/过失致人死亡罪.json',
                    help='Query path.')
parser.add_argument('--split', type=str, default='C:/Users/11649/Desktop/LCR/data/corpus/故意杀人罪/gysr_corpus.json',
                    help='Split corpus path.')
parser.add_argument('--w', type=str, default='C:/Users/11649/Desktop/LCR/data/prediction/tfidf_top100_gszrsw_gysr.json',
                    help='Write path.')
