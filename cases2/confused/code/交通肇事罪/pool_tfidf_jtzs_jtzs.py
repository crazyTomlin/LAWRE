...
parser.add_argument('--s', type=str, default='C:/Users/11649/Desktop/LCR/data/others/stopword.txt',
                    help='Stopword path.')
parser.add_argument('--q', type=str, default='C:/Users/11649/Desktop/LCR/data/query/交通肇事罪.json',
                    help='Query path.')
parser.add_argument('--split', type=str, default='C:/Users/11649/Desktop/LCR/data/corpus/交通肇事罪/jtzs_corpus.json',
                    help='Split corpus path.')
parser.add_argument('--w', type=str, default='C:/Users/11649/Desktop/LCR/data/prediction/tfidf_top100_jtzs_jtzs.json',
                    help='Write path.')
