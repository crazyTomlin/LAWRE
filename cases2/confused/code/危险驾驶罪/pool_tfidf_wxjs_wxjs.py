...
parser.add_argument('--s', type=str, default='C:/Users/11649/Desktop/LCR/data/others/stopword.txt',
                    help='Stopword path.')
parser.add_argument('--q', type=str, default='C:/Users/11649/Desktop/LCR/data/query/危险驾驶罪.json',
                    help='Query path.')
parser.add_argument('--split', type=str, default='C:/Users/11649/Desktop/LCR/data/corpus/危险驾驶罪/wxjs_corpus.json',
                    help='Split corpus path.')
parser.add_argument('--w', type=str, default='C:/Users/11649/Desktop/LCR/data/prediction/tfidf_top100_wxjs_wxjs.json',
                    help='Write path.')
