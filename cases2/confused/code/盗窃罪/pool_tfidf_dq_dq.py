...
parser.add_argument('--q', type=str, default='C:/Users/11649/Desktop/LCR/data/query/盗窃罪.json',
                    help='Query path.')
parser.add_argument('--split', type=str, default='C:/Users/11649/Desktop/LCR/data/corpus/盗窃罪/dq_corpus.json',
                    help='Split corpus path.')
parser.add_argument('--w', type=str, default='C:/Users/11649/Desktop/LCR/data/prediction/tfidf_top100_dq_dq.json',
                    help='Write path.')
