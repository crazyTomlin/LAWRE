...
parser.add_argument('--s', type=str, default='C:/Users/11649/Desktop/LCR/data/others/stopword.txt',
                    help='Stopword path.')
parser.add_argument('--q', type=str, default='C:/Users/11649/Desktop/LCR/data/query/盗窃罪.json',
                    help='Query path.')
...
parser.add_argument('--w', type=str, default='C:/Users/11649/Desktop/LCR/data/prediction/tfidf_top100_dq_qj.json',
                    help='Write path.')
